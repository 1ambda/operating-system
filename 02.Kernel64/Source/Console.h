...
#define CONSOLE_FOREGROUND_DARKREDCK		0x04
...
#define CONSOLE_DEFAULT_TEXTCOLOR	( CONSOLE_BACKGROUND_BLACK | CONSOLE_FOREGROUND_DARKWHITE )

#define CONSOLE_SCREEN_WIDTH		80
#define CONSOLE_SCREEN_HEIGHT		25
#define CONSOLE_SCREEN_ADDRESS		0xB8000

#define CRTC_ADR	0x3D4
#define CRTC_CDR	0x3D5

#define CRTC_ADR_CURSOR_UPPER	0x0E
#define CRTC_ADR_CURSOR_LOWER	0x0F

#pragma pack(push, 1)

typedef struct kConsoleManagerStruct
{
	int nCurrentPrintOffset;
} CONSOLE_MANAGER;
